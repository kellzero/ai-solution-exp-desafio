...
- Tela de Configurações usa `supabase.auth.updateUser()`; o nome do usuário é armazenado em `user_metadata`, já que `auth.users` não possui coluna nativa para isso.
